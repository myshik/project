  ...
  <div class="content">
    <form id="form" action="<?php echo $action; ?>" method="post">
      ...
      <div style="padding-left:620px;">
        <table id="block_option" style="width: 400px;">
          <thead>
            <tr><th align="left" style="width: 185px;"><?php echo $entry_values; ?></th></th>
          
            <th align="left" style="width: 185px;"><?php echo $entry_sort_order; ?></th><th>&nbsp;</th></tr>
          </thead>
          ...
          <?php foreach ($option_values as $value) { ?>
            ...
            <td align="center" style="background-color: #F5EFD1;padding:4px;"><input type="text" name="option_value[<?php echo $value['value_id']; ?>][filter_sort_order]" value="<?php echo $value['filter_sort_order']; ?>" size="20" /></td>              
              <td align="center">
...
function addValue() {
  ...
  <?php } ?>
  	html += '</td>';
  	html += '<td align="center" style="background-color: #F5EFD1;padding:4px;"><input type="text" name="option_value[' + option_value_row + '][filter_sort_order]" value="<?php echo $filter_sort_order; ?>" size="20" /></td>';   
