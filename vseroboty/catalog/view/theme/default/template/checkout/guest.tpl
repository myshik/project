...
<div class="right" id="address-display">
  ...
  </div>  Пример; г. Москва, ул. Московская д.1 кв.1
  <span style="display:none" class="required">*</span> 
  <input style="display:none" type="text" name="city" value="<?php echo $city; ?>" class="large-field" />
 
  <span style="display:none" id="payment-postcode-required" class="required">*</span> 
  <input style="display:none" type="text" name="postcode" value="<?php echo $postcode; ?>" class="large-field" />
  <br />
  <br />
