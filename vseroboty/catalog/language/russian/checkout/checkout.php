...
$_['text_shipping_method']           = 'Пожалуйста выберите способ доставки (если доставка будет производиться в Московсую область или другой город РФ, то оставьте выбор по умолчанию, точную стоимость доставки сообщит менеджер):';
