...
$_['text_new_greeting']         = 'Благодарим за интерес к товарам %s. Ваш заказ поступил в обработку. В ближайшее время наш менеджер свяжется с Вами.';
...
$_['text_new_date_added']       = 'Дата создания заказа:';
...
$_['text_new_powered']			= '<a href="http://vseroboty.ru">ВсеРоботы.ру</a>';
