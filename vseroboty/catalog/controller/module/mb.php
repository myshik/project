...
class ControllerModuleMb extends Controller {
	protected function index($setting) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/mb.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/mb.tpl';
		} else {
			$this->template = 'default/template/module/mb.tpl';
		}
