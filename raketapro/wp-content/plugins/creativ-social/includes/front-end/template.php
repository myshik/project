	...
	<div class="creativsocial">
		...
		<?php // Assuming there is, let's go ahead and display the ones that have been filled ?>
		    ...
		    <ul <?php /* Again, this is for the new Type option in an upcoming version.
		    	...
		    	<?php if ( $pinterest !='' ) { ?>
		    	<li class="pinterest">
		    	    <a href="<?php echo $pinterest; echo $currentpage; ?>" target="_blank" title="Facebook"></a>
		    	</li>
		    	<?php } ?>
		    	<?php if ( $youtube !='' ) { ?>
		    	<li class="youtube">
		    	    <a href="<?php echo $youtube; echo $currentpage; ?>" target="_blank" title="Twitter"></a>
		    	</li>
		    	<?php } ?>
		    	<?php if ( $vimeo !='' ) { ?>
		    	 <li class="vimeo">
		    	    <a href="<?php echo $vimeo; echo $currentpage; ?>" target="_blank" title="Google Plus"></a>
		    	</li>
		    	<?php } ?>
		    	<?php if ( $flickr !='' ) { ?>
		    	 <li class="flickr">
                ...
                <?php if ( $linkedin !='' ) { ?>
		    	 <li class="linkedin">
		    	    <a href="<?php echo $linkedin; echo $currentpage; ?>" target="_blank" title="VK"></a>
		    	</li>
		    	<?php } ?>
                <?php if ( $rss !='' ) { ?>
		    	 <li class="rss">
